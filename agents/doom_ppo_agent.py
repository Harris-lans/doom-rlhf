...
class DoomPpoAgent(PpoAgent):
    ...
    def __init__(self, observation_space, action_space, models_path=None, learning_rate=0.00025):
        """
        ...
        super().__init__(base_network, actor_network, critic_network, observation_space.shape, action_space.shape, models_path, learning_rate)
